...
<div>
  ...
  {:else if error}
    <div class="card-neumorphic bg-red-50 text-center py-6 mb-6">
    ...
    />
  {:else if success}
    <div class="card-neumorphic bg-green-50 text-center py-12">
      <div class="neumorphic h-16 w-16 mx-auto mb-4 flex items-center justify-center">
